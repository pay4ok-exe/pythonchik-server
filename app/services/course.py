...
class CourseService:
    ...
    def get_all_courses(self, user_id=None):
        try:
            ...
            self.db.rollback()
            print(f"Database error in get_all_courses: {str(e)}")
            return []
    ...
    def get_course_with_topics(self, course_id, user_id=None):
        try:
            ...
            self.db.rollback()
            print(f"Database error in get_course_with_topics: {str(e)}")
            return None
        except Exception as e:
            print(f"Unexpected error in get_course_with_topics: {str(e)}")
            return None